    ...
    <div class="admin-dashboard">
      ...
      <div class="main--content">
        ...
        <div class="card--container">
            <form class="form card" @submit.prevent="addAdmin">
                <div class="card_header">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z"></path>
                        <path fill="currentColor" d="M4 15h2v5h12V4H6v5H4V3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-6zm6-4V8l5 4-5 4v-3H2v-2h8z"></path>
                    </svg>
                    <h1 class="form_heading">Add Admin</h1>
                </div>
                <div class="field">
                    <label for="username">Adminname</label>
                    <input class="input" v-model="newAdmin.adminname" name="username" type="text" placeholder="Adminname" id="username">
                </div>
                <div class="field">
                    <label for="password">Password</label>
                    <input class="input" v-model="newAdmin.password" name="user_password" type="password" placeholder="Password" id="password">
                </div>
                <div class="field">
                    <button type="submit" class="button">Add Admin</button>
                </div>
            </form>
            <div v-if="addSuccess" class="success">Admin Added Successfully</div>
  ...
  export default {
    ...
    methods: {
      ...
      axios.post('http://localhost:3000/admin', this.newAdmin)
        ...
        .catch(error => {
          console.error('Error occur when adding admin:', error);
          this.addSuccess = false;
          this.addError = 'Something went wrong! Error 404!';
        });
      }
